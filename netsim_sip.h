...
struct netsim_sip_config {
  char username[NETSIM_SIP_USER_BUFSIZE];
  char password[NETSIM_SIP_PASSWORD_BUFSIZE];
  char server_host[NETSIM_SIP_HOST_BUFSIZE];
  char server_port[NETSIM_SIP_PORT_BUFSIZE];
...
bool netsim_sip_start_call(struct netsim_sip *sp, uint64_t session_nonce,
